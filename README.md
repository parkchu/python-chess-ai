...
## ver.1 기능 구현
- 플레이어 끼리 체스를 둘 수 있도록 구현
- 선택한 기물의 움직일 수 있는 위치를 볼 수 있음
- 폰 프로모션 구현됨
- 무르기 구현됨
- 체크메이트 구현됨
- 스테일메이트 구현됨
...
- [X] 움직일 기물이 움직일 위치로 이동할 수 있는 범위여야함
- [X] 움직일 기물이 이동하는 거리는 NonePiece 여야함
- [X] 움직일 기물이 움직일 위치에 같은팀 기물이 있으면 안됨
- [x] 기물을 이동한 후 본인이 체크 상태이면 안됨
